...
public class AdaptadorUsuario implements IAdaptadorUsuarioDAO {
	...
	public void registrarUsuario(Usuario usuario) {
		...
		eUsuario.setPropiedades(new ArrayList<Propiedad>(Arrays.asList(new Propiedad(propLogin, usuario.getLogin()),
				new Propiedad(propPassword, usuario.getPassword()), new Propiedad(propNombre, usuario.getNombre()),
	...
	public Usuario recuperarUsuario(int codigo) {
		...
		List<ListaVideos> listas = obtenerListasVideosDesdeCodigos(
				servPersistencia.recuperarPropiedadEntidad(eUsuario, propListas));
