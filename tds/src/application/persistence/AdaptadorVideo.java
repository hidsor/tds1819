...
public class AdaptadorVideo implements IAdaptadorVideoDAO {
	...
	public void registrarVideo(Video video) {
		...
		eVideo.setPropiedades(new ArrayList<Propiedad>(
				Arrays.asList(new Propiedad(propURL, video.getURL()), new Propiedad(propTitulo, video.getTitulo()),
	...
	public Video recuperarVideo(int codigo) {
		...
		int numReproducciones = Integer
				.parseInt(servPersistencia.recuperarPropiedadEntidad(eVideo, propNumReproducciones));

		Video video = new Video(URL, titulo, numReproducciones);
		video.setCodigo(codigo);
		Set<Etiqueta> etiquetas = obtenerEtiquetasDesdeString(
				servPersistencia.recuperarPropiedadEntidad(eVideo, propEtiquetas));
